...
export default class Feed extends React.Component {
  ...
  componentDidMount() {
    ...
    // getThoughts(firebase, (data) => {   this.setState({     thoughts: data   } //
    // , () => console.log(this.state.thoughts) ) }, 3)

    let data = [
      {
        id: "11408490526444331",
        thought: "44 So this will be an example of a 140 character count, this will determine the num" +
            "ber of characters per card is too much or too little. Cool!!"
      }, {
        id: "9124782621170115",
        thought: "222So this will be an example of a 140 character count, this will determine the num" +
            "ber of characters per card is too much or too little. Cool!!"
      }, {
        id: "1735670627037965",
        thought: "55So this will be an example of a 140 character count, this will determine the num" +
            "ber of characters per card is too much or too little. Cool!!"
      }
    ]
